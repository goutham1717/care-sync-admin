...
const documents: Documents = {
    ...
    "\n  mutation CreateClinicMilestone($input: CreateClinicMilestoneDTO!) {\n    createClinicMilestone(input: $input) {\n      id\n      clinicId\n      title\n      description\n      metricType\n      targetValue\n      rewardType\n      rewardValue\n      isActive\n      repeatable\n      sortOrder\n      createdAt\n      updatedAt\n    }\n  }\n": types.CreateClinicMilestoneDocument,
    "\n  mutation UpdateClinicMilestone($input: UpdateClinicMilestoneDTO!) {\n    updateClinicMilestone(input: $input) {\n      id\n      clinicId\n      title\n      description\n      metricType\n      targetValue\n      rewardType\n      rewardValue\n      isActive\n      repeatable\n      sortOrder\n      createdAt\n      updatedAt\n    }\n  }\n": types.UpdateClinicMilestoneDocument,
    "\n  mutation DeleteClinicMilestone($milestoneId: String!) {\n    deleteClinicMilestone(milestoneId: $milestoneId)\n  }\n": types.DeleteClinicMilestoneDocument,
    "\n  mutation EvaluateClinicMilestones($clinicId: String!) {\n    evaluateClinicMilestones(clinicId: $clinicId) {\n      id\n      clinicId\n      milestoneId\n      sequence\n      progressValue\n      status\n      rewardPayload\n      errorMessage\n      achievedAt\n      rewardedAt\n    }\n  }\n": types.EvaluateClinicMilestonesDocument,
    ...
    "\n  query GetClinicMilestones($clinicId: String!) {\n    getClinicMilestones(clinicId: $clinicId) {\n      id\n      clinicId\n      title\n      description\n      metricType\n      targetValue\n      rewardType\n      rewardValue\n      isActive\n      repeatable\n      sortOrder\n      createdAt\n      updatedAt\n    }\n  }\n": types.GetClinicMilestonesDocument,
    "\n  query GetClinicMilestoneProgress($clinicId: String!) {\n    getClinicMilestoneProgress(clinicId: $clinicId) {\n      id\n      clinicId\n      title\n      description\n      metricType\n      targetValue\n      rewardType\n      rewardValue\n      isActive\n      repeatable\n      sortOrder\n      currentProgress\n      achievedCount\n      remainingToUnlock\n      isCompleted\n      progressPercent\n      latestRewardedAt\n    }\n  }\n": types.GetClinicMilestoneProgressDocument,
